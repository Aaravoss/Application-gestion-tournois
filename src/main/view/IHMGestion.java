...
import static main.utils.BusinessConstants.TAILLE_BTN_Y;
        ...
        for (Tournoi tournoi : this.tournois) {
            ...
            btnTournoi.setOnAction(new EventHandler<ActionEvent>() {
                ...
                public void handle(ActionEvent actionEvent) {
                    if(tournoi instanceof main.model.tournoi.type.LoserBracket) {
                        main.view.IHMAffichageLoserBracket page = new main.view.IHMAffichageLoserBracket(tournoi);
                        page.start(stage);
                    } else if(tournoi instanceof main.model.tournoi.type.Poule) {
                        main.view.IHMAffichagePoule page = new main.view.IHMAffichagePoule();
                        page.start(stage);
                    }
